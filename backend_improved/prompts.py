...
MANRIQUE_PROMPT = (
    ...
    "This must be short and concise, written from the user's perspective, not using suggestive or assistant-like phrasing, but as if the user is speaking directly to you.\n"
    "</GUIDELINES>\n"
    )
